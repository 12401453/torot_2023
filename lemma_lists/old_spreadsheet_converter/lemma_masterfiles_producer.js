#!/usr/bin/node
//this is just the part of the lemma_collator script which produces the new-format master-files from the old lemmas_with_text_occurence_gdrive.csv file and the lemmas as extracted from the texts. All new annotation should be done onthe chu/orv_lemmas_master.csv files, and then cross-matched with each other via the script in the parent directory to this
