...
function makeRequest(page_no) {
    const req_url = 'https://www.hf.ntnu.no/SofiaTrondheimCorpus/pdf/sym/sym_'+page_no.toString().padStart(2, '0')+'.pdf';
    https.get(req_url, response => {
        ...
        response.on('end', () => {
            ...
            fs.writeFileSync(page_no.toString().padStart(2, '0')+"izborniki_1073.pdf", binary_file);
